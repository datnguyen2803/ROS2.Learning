...
public:
	...
	: Node("fibonacci_server", options)
	{
		...
		RCLCPP_INFO(this->get_logger(), "Fibonacci action has been initialized.");
	}
private:
	...
	{
		using namespace std::placeholders;
		// this needs to return a shared pointer to a result structure
...
RCLCPP_COMPONENTS_REGISTER_NODE(cpp_action_server::FibonacciServer)
