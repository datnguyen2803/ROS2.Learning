...
# This lanch file is copied from package nav2_bringup - navigation_launch.py - branch humble
# URL: https://github.com/ros-planning/navigation2/blob/humble/nav2_bringup/launch/navigation_launch.py
...
def generate_launch_description():
	...
	configured_params = ParameterFile(
		RewrittenYaml(
			...
			source_file=os.path.join(navigation_dir, 'config', 'nav2_params.yaml'),
			root_key=namespace,
